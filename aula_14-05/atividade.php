...
<body>
    ...
    <pre>
        <?php
            // Função para exibir arrays de forma legível
            ...
            echo "Bairro 'Centro' existe: " . ($existeBairroCentro ? 'true' : 'false') . "\n";
            echo"<br>";

            echo "<h3>6. isset: Verifica se a variável foi inicializada</h3>";
            $var = "Teste";
            $varInicializada = isset($var);
            echo "Variável 'var' inicializada: " . ($varInicializada ? 'true' : 'false') . "\n";
            echo"<br>";

            echo "<h3>7. unset: Destrói a variável</h3>";
            unset($var);
            $varInicializada = isset($var);
            echo "Variável 'var' inicializada após unset: " . ($varInicializada ? 'true' : 'false') . "\n";
            echo"<br>";

            echo "<h3>8. empty: Verifica se a variável está vazia</h3>";
            $vazia = empty($var);
            echo "Variável 'var' está vazia: " . ($vazia ? 'true' : 'false') . "\n";
            echo"<br>";
            ...
            echo "Array após array_combine:\n";
            print_array($arrayCombine);
            echo"<br>";
            ...
            echo "Diferença entre array1 e array2:\n";
            print_array($arrayDiff);
            echo"<br>";

            echo "<h3>18. array_intersect: Encontra a intersecção entre dois arrays</h3>";
            $arrayIntersect = array_intersect($array1, $array2);
            echo "Intersecção entre array1 e array2:\n";
            print_array($arrayIntersect);
            echo"<br>";
        ?>
    </pre>
</body>
